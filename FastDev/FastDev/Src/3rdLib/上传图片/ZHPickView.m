...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    NSDate *minLDate = [minDate  dateByAddingTimeInterval: Interval];
    datePicker.minimumDate = minLDate;
...
-(void)doneClick
{
    if (_pickerView) {
        ...
        NSDate *maxDate=_datePicker.date;
        NSTimeZone *zone = [NSTimeZone systemTimeZone];
        NSInteger interval = [zone secondsFromGMTForDate: maxDate];
        NSDate *maxLDate = [maxDate  dateByAddingTimeInterval: interval];
        _resultString=[NSString stringWithFormat:@"%@",maxLDate];
    }
